...
local function get_groups()
  ...
  local groups = {
    ...
    MiniStatuslineModeCommand = { fg = colors.bg0, bg = colors.blue, bold = config.bold, nocombine = true },
    MiniStatuslineModeInsert = { fg = colors.bg0, bg = colors.orange, bold = config.bold, nocombine = true },
    MiniStatuslineModeNormal = { fg = colors.bg0, bg = colors.fg3, bold = config.bold, nocombine = true },
    ...
    MiniStatuslineModeVisual = { fg = colors.bg0, bg = colors.yellow, bold = config.bold, nocombine = true },
...
Gruvbox.load = function()
  if vim.version().minor < 8 then
    vim.notify_once("gruvyboxy.nvim: you must use neovim 0.8 or higher")
    return
  end
